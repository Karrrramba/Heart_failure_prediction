...
- log-transform: age, creatinin_phospokinase, ejection_fraction, platelets, serum_sodium, time?
- box-cox: serum_creatinine, time?
...
preds_transformed %>% 
  ...
  ggplot(data = preds_transformed, aes(x = serum_creatinine)) +
  geom_histogram(bins = 15, col = "darkred", fill = "#D53E4F") +
